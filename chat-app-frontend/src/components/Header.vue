        ...
        <nav class="tyn-appbar">
            <div class="tyn-appbar-wrap">
                <div class="tyn-appbar-logo">
                    <router-link to="/index" class="tyn-logo">
                ...
                <div class="tyn-appbar-content">
                    <ul class="tyn-appbar-nav tyn-appbar-nav-start">
                        <li class="tyn-appbar-item">
                            <router-link to="/index" :class="{ active: $route.path === '/index' }" class="tyn-appbar-link">
                        ...
                        <li class="tyn-appbar-item">
                            <router-link class="tyn-appbar-link" :class="{ active: $route.path === '/contacts' }" to="/contacts">
                        ...
                        <li class="tyn-appbar-item d-none d-sm-inline-flex">
                            <router-link to="/chat-bot" :class="{ active: $route.path === '/chat-bot' }" class="tyn-appbar-link">
                        ...
                        <li class="tyn-appbar-item d-none d-sm-inline-flex">
                            <router-link to="/stories" :class="{ active: $route.path === '/stories' }" class="tyn-appbar-link">
                        ...
                        <li class="tyn-appbar-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-auto dropdown-menu-end">
                                <ul class="tyn-list-links">
                                    ...
                                    <li>
                                        <router-link to="/chat-bot-welcome">
